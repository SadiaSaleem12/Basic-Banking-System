    ...
    ?>
 		...
 		<div>	<br>
           ...
           <input type="hidden" class="form-control" id="from" value="<?php echo($id)?>" name="from">
			    ...
			    <div class="form-group">
			      <label class="control-label col-sm-2" for="amt" required>Please Enter Amount:</label>
			      <div class="col-sm-5">          
        		...
        		<button class="btn btn-warning" name="submit" type="submit"  style="font-weight: bold;">Transfer
        		</button></a>
     			 </div>
    			</div>
			 </form>
...
<div class="absolute">        
  <footer class="text-center mt-5 py-2" style="margin-top:20%;"> 
        <p>&copy 2021 Made by <b>Sadia Saleem</b></p>
    </footer>
</div>
